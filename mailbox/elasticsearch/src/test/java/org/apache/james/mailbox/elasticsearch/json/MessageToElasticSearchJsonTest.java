...
public class MessageToElasticSearchJsonTest {
    ...
    private MailboxMessage createMockMessage(String resource) throws IOException {
        return MessageUtil.buildMailboxMessage()
            ...
            .content(new SharedByteArrayInputStream(IOUtils.toByteArray(ClassLoader.getSystemResourceAsStream(resource))))
            .flags(new Flags())
    ...
    public void convertToJsonShouldThrowWhenNoUser() throws Exception {
        ...
        MailboxMessage spamMail = createMockMessage("eml/spamMail.eml");
    ...
    public void emailWithAttachmentsShouldConvertAttachmentsWhenIndexAttachmentsIsTrue() throws IOException {
        ...
        String convertToJson = messageToElasticSearchJson.convertToJson(mail, ImmutableList.of(new MockMailboxSession("username").getUser()));
    ...
    public void spamEmailShouldBeWellConvertedToJsonWithApacheTika() throws IOException {
        MessageToElasticSearchJson messageToElasticSearchJson = new MessageToElasticSearchJson(
            ...
            ZoneId.of("Europe/Paris"),
            IndexAttachments.YES);
        MailboxMessage spamMail = createMockMessage("eml/nonTextual.eml");
        assertThatJson(messageToElasticSearchJson.convertToJson(spamMail, ImmutableList.of(new MockMailboxSession("username").getUser())))
            .when(IGNORING_ARRAY_ORDER)
