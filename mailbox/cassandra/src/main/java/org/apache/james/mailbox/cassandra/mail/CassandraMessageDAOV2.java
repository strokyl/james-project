...
public class CassandraMessageDAOV2 {
            ...
            ids -> FluentFutureStream.of(
                ids.stream()
                    .map(id -> retrieveRow(id, fetchType)
                        .thenCompose((ResultSet resultSet) ->
    ...
    private CompletableFuture<Pair<MessageWithoutAttachment, Stream<MessageAttachmentRepresentation>>>
            message(Row row,ComposedMessageIdWithMetaData messageIdWithMetaData, FetchType fetchType) {
